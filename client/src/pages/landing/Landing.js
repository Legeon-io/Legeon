...
import { FaLinkedin, FaTag } from "react-icons/fa";
            ...
            <div className="flex flex-col gap-2 w-full h-full items-center text-xl">
              ...
              <div className="w-[80%]">
                ...
                <p>
                  ...
                  enim iure illum eligendi dolor, voluptatem itaque illo
                  repudiandae id vel.
                </p>
              </div>
              <div className="w-[80%]">
                ...
                <p>
                  ...
                  minima temporibus ipsum sed consectetur doloribus veniam natus
                  aspernatur dolorum facilis vel dolores!
                </p>
              </div>
            </div>
          </div>
