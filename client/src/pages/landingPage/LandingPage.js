        ...
        <div className="flex flex-col gap-20 select-none">
          ...
          <div className="relative flex flex-col gap-5">
            ...
            <div className="flex flex-col sm:gap-20 lg:p-10 p-3">
              <div className="z-0 flex md:flex-row flex-col justify-around items-center lg:gap-20 sm:gap-2 gap-20 sm:p-0 xs:p-10 p-3">
                <Zoom>
                  <div className="relative group hover:text-white text-indigo-500 flex flex-col justify-around items-center min-h-[25rem] md:w-[23rem] lg:p-10 xs:p-5 p-3 shadow-lg border-2 rounded-2xl overflow-hidden">
                    ...
                    <p className="text-center text-lg  z-10">
                      As an influencer or expert, easily host 1-on-1 sessions
                      and set your prices for services. Monetize your skills
                      without the hassle of managing bookings.
                    </p>
                  </div>
                </Zoom>
              ...
              <div className="flex flex-col gap-5 sm:p-10 p-5">
                <div className="grid grid-cols-3 gap-5">
                  ...
                  <div className="flex flex-col justify-center items-center">
                    ...
                    <p>
                      Legeon is not just a platform; it's your gateway to
