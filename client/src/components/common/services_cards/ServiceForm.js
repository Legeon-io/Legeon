                        ...
                        <div className='call-field'>
...

                            {
                                ...
                                <>
                                    ...
                                    style={{marginLeft:'30px', fontSize: '18px', color: '#C5C6C7', 
                                            width:'50%'}}/>
                                    <br />
                                </>
                            }

                            {
                                ...
                                <>
                                    ...
                                    placeholder='Enter time in minutes' style={{marginLeft:'30px', fontSize: '18px',
                        ...
                        <div className='price-field'>
...

                            {
                                ...
                                <>
                                    ...
                                    placeholder='Enter the amount' style={{marginLeft:'25px', fontSize: '18px',
                                    color: '#C5C6C7', width:'50%'}} />
                                    <br />
                                </>
                            }
